Algoritmo Proyecto_sistema_de_costos
	...
	costoenvio<-10
	pesopaquete<-3
	//Realizar calculo para cup?n de descuento 
	...
	costoEnvio<-10+(2*3)
	//Realizar calculo del producto final m?s el env?o de un par
	precioFinal1<-(precioIVA*1)+costoEnvio
	//Realizar calculo del producto final m?s el env?o de dos pares
	...
	Fin Si
	// Calculo final del producto m?s el env?o 
	Escribir "Ingrese cantidad final del pedido:"
	Leer pedidoFinal
	Si pedidoFinal>=2 Entonces
		Escribir "El precio total de 2 pares m?s el costo de env?o es de $", precioFinal2
	SiNo
		Escribir "El precio total de 1 par m?s el costo de env?o es de $", precioFinal1
	Fin Si
	...
	Escribir "El precio del producto con cup?n de descuento es de = $", descuentoCupon
	Escribir "El precio del producto con descuento m?s el IVA agregado es de = $", precioIVA
	Escribir "El precio del producto si llevas dos pares, cada producto tiene un valor de = $", descuentoxCantidad
	Escribir "El costo de env?o tiene un valor de = $", costoEnvio
	Escribir "El precio final de un producto m?s el env?o es de = $", precioFinal1
	Escribir "El precio final de dos productos m?s el env?o es de = $", precioFinal2
